        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="fixed inset-0 flex items-center justify-center p-4">
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-lef align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                ...
                <div className="mt-4">
                    ...
                    className="inline-flex justift-center rounded-md border border-transparent bg-blue-100 px-4 py-2 
